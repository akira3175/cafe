...
import com.core.cafe_shop_maven.BUS.ThongKeBUS;
...
public class PnQuanLyThongKeGUI extends JPanel {
    ...
    private void addControls() {
        ...
        JLabel lblBackGroundBangChiTiet = new JLabel(
                new ImageIcon("src/main/resources/image/ManagerUI/bangChiTiet.png"));
